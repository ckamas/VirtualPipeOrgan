...
void TabStopsReadingEngine::MidiSendTabOn(uint8_t tab) {
  ...
  Serial.print("Setting tab "); Serial.print(tab); Serial.println(" to on");
}
...
void TabStopsReadingEngine::MidiSendTabOff(uint8_t tab) {
  ...
  Serial.print("Setting tab "); Serial.print(tab); Serial.println(" to off");
}
